...
public class DepartmentDAO {
    ...
    public Page<Department> paging(String column, String value,
                               int currentPage, int pageSize, String orderBy, String sortBy )
    {
        try (Session session = entityManager.openSession()) {
            ...
            if(orderBy != null){
                ...
                pageable = PageRequest.of(currentPage / pageSize, pageSize,
                        "DESC".equalsIgnoreCase(orderBy) ? Sort.by(orderBy).descending()
