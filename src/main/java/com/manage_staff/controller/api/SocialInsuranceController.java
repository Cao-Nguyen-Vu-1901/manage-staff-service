...
@RestController
@RequestMapping("/api/social-insurances")
...
public class SocialInsuranceController {
    ...
    @GetMapping
    public PagingResponse<List<SocialInsuranceResponse>> getAll(
        ...
        return PagingResponse.<List<SocialInsuranceResponse>>builder()
                ...
                .pageSize(pageSize)
                .sortBy(sortBy)
                .totalPage(socialInsuranceResponses.getTotalPages())
                .totalItem(socialInsuranceResponses.getTotalElements())
                .orderBy(orderBy)
                .type(type)
                .value(value)
                .result(socialInsuranceResponses.getContent())
                .build();
    }
    ...
    public ApiResponse<SocialInsuranceResponse> getById(@PathVariable String id) {
        return ApiResponse.<SocialInsuranceResponse>builder()
                .result(socialInsuranceService.findById(id))
                .build();
    }
    ...
    public ApiResponse<SocialInsuranceResponse> save(@Valid @RequestBody SocialInsuranceRequest request) {
        return ApiResponse.<SocialInsuranceResponse>builder()
                .result(socialInsuranceService.save(request))
                .build();
    }
    ...
    public ApiResponse<String> delete(@PathVariable String id) {
        ...
        return ApiResponse.<String>builder()
                .result("Social insurance has been delete")
                .build();
    }

    @PutMapping("/{id}")
    public ApiResponse<SocialInsuranceResponse> delete(
            @PathVariable String id, @Valid @RequestBody SocialInsuranceUpdateRequest request) {

        return ApiResponse.<SocialInsuranceResponse>builder()
                .code(1000)
                .result(socialInsuranceService.update(id, request))
                .build();
    }
}
