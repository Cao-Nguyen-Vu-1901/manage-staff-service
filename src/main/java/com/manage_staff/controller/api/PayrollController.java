...
public class PayrollController {
    ...
    @GetMapping
    public PagingResponse<List<PayrollResponse>> getAll(
        ...
        return PagingResponse.<List<PayrollResponse>>builder()
                ...
                .pageSize(pageSize)
                .sortBy(sortBy)
                .totalPage(payrollResponses.getTotalPages())
                .totalItem(payrollResponses.getTotalElements())
                .orderBy(orderBy)
                .type(type)
                .value(value)
                .result(payrollResponses.getContent())
                .build();
    }
    ...
    public ApiResponse<PayrollResponse> getById(@PathVariable String id) {
        return ApiResponse.<PayrollResponse>builder()
                .result(payrollService.findById(id))
                .build();
    }
    ...
    public ApiResponse<PayrollResponse> create(@Valid @RequestBody PayrollRequest request) {
        return ApiResponse.<PayrollResponse>builder()
                .result(payrollService.save(request))
                .build();
    }
    ...
    public ApiResponse<PayrollResponse> update(@PathVariable String id, @RequestBody PayrollRequest request) {
        return ApiResponse.<PayrollResponse>builder()
                .code(1000)
                .result(payrollService.update(id, request))
                .build();
    }
}
