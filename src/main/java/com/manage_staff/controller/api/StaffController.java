...
public class StaffController {
    ...
    @GetMapping
    public PagingResponse<List<StaffResponse>> paging(
            ...
            String sortBy,
            String orderBy) {
        Page<StaffResponse> staff = staffService.pagingStaff(currentPage, pageSize, type, value, sortBy, orderBy);
        ...
        return PagingResponse.<List<StaffResponse>>builder()
                ...
                .pageSize(pageSize)
                .sortBy(sortBy)
                .totalPage(staff.getTotalPages())
                .totalItem(staff.getTotalElements())
                .orderBy(orderBy)
                .type(type)
                .value(value)
                .result(staff.getContent())
                .build();
    }

    @PostMapping
    public ApiResponse<StaffResponse> save(@Valid StaffRequest request, @RequestParam("file") MultipartFile file)
            throws IOException {
        return ApiResponse.<StaffResponse>builder()
                .code(1000)
                .result(staffService.save(request, file))
                .build();
    }
    ...
    public ApiResponse<String> delete(@PathVariable String id) {
        ...
        return ApiResponse.<String>builder().message("Staff have been delete").build();
    }
    ...
    public ApiResponse<StaffResponse> update(
        ...
        return ApiResponse.<StaffResponse>builder()
                .code(1000)
                .result(staffService.update(id, request, file))
                .build();
    }
}
