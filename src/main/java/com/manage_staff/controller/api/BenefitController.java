...
public class BenefitController {
    ...
    @GetMapping
    public PagingResponse<List<BenefitResponse>> getAllBenefits(
            ...
            String sortBy,
            String orderBy) {
        Page<BenefitResponse> benefitResponsePage =
                benefitService.paging(type, value, currentPage, pageSize, orderBy, sortBy);
        ...
        return PagingResponse.<List<BenefitResponse>>builder()
                ...
                .pageSize(pageSize)
                .sortBy(sortBy)
                .totalPage(benefitResponsePage.getTotalPages())
                .totalItem(benefitResponsePage.getTotalElements())
                .orderBy(orderBy)
                .type(type)
                .value(value)
                .result(benefitResponsePage.getContent())
                .build();
    }
    ...
    public ApiResponse<BenefitResponse> getById(@PathVariable String id) {
        return ApiResponse.<BenefitResponse>builder()
                .result(benefitService.findById(id))
                .build();
    }
    ...
    public ApiResponse<BenefitResponse> create(@Valid @RequestBody BenefitRequest request) {
        return ApiResponse.<BenefitResponse>builder()
                .result(benefitService.save(request))
                .build();
    }
    ...
    public ApiResponse<BenefitResponse> update(@PathVariable String id, @Valid @RequestBody BenefitRequest request) {
        return ApiResponse.<BenefitResponse>builder()
                .code(1000)
                .result(benefitService.update(id, request))
                .build();
    }
}
